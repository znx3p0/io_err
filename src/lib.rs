...
macro_rules! err {
    (not_found, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::NotFound, $e))
    };
    (permission_denied, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::PermissionDenied, $e))
    };
    (conn_refused, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::ConnectionRefused, $e))
    };
    (conn_reset, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::ConnectionReset, $e))
    };
    (host_unreachable, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::HostUnreachable, $e))
    };
    (net_unreachable, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::NetworkUnreachable, $e))
    };
    (conn_aborted, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::ConnectionAborted, $e))
    };
    (not_connected, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::NotConnected, $e))
    };
    (in_use, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::AddrInUse, $e))
    };
    (addr_not_available, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::AddrNotAvailable, $e))
    };
    (net_down, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::NetworkDown, $e))
    };
    (broken_pipe, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::BrokenPipe, $e))
    };
    (already_exists, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::AlreadyExists, $e))
    };
    (would_block, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::WouldBlock, $e))
    };
    (not_a_dir, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::NotADirectory, $e))
    };
    (is_a_dir, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::IsADirectory, $e))
    };
    (dir_not_empty, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::DirectoryNotEmpty, $e))
    };
    (read_only_fs, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::ReadOnlyFilesystem, $e))
    };
    (fs_loop, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::FilesystemLoop, $e))
    };
    (stale_net_filehandle, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::StaleNetworkFileHandle, $e))
    };
    (invalid_input, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::InvalidInput, $e))
    };
    (invalid_data, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::InvalidData, $e))
    };
    (timeout, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::TimedOut, $e))
    };
    (write_zero, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::WriteZero, $e))
    };
    (storage_full, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::StorageFull, $e))
    };
    (not_seekable, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::NotSeekable, $e))
    };
    (fs_quota_exceeded, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::FilesystemQuotaExceeded, $e))
    };
    (file_too_large, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::FileTooLarge, $e))
    };
    (resource_busy, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::ResourceBusy, $e))
    };
    (executable_busy, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::ExecutableFileBusy, $e))
    };
    (deadlock, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::Deadlock, $e))
    };
    (crosses_devices, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::CrossesDevices, $e))
    };
    (too_many_links, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::TooManyLinks, $e))
    };
    (filename_too_long, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::FilenameTooLong, $e))
    };
    (argument_list_too_long, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::ArgumentListTooLong, $e))
    };
    (interrupted, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::Interrupted, $e))
    };
    (unsupported, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::Unsupported, $e))
    };
    (unexpected_eof, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::UnexpectedEof, $e))
    };
    (out_of_memory, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::OutOfMemory, $e))
    };
    (other, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::Other, $e))
    };
    (uncategorized, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::Uncategorized, $e))
    };
    ($p: ident, $e: expr) => {
        $crate::Error::new(::std::io::Error::new(::std::io::ErrorKind::$p, $e))
    };
    ...
    ($p: ident, $fmt:expr, $($arg:tt)*) => {
        $crate::err!($p, format!($fmt, $($arg)*))
    };
    ($fmt:expr, $($arg:tt)*) => {
        $crate::err!(format!($fmt, $($arg)*))
    };
}
